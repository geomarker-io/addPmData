...
The repository of code used to build the exposure model can be found at https://github.com/geomarker-io/st_pm_hex and an accompanying preprint manuscript is available at (preprint DOI: https://doi.org/10.20944/preprints202109.0164.v1).
