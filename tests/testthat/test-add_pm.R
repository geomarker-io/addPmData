...
test_that("1 h3 available, 2 aggregated h3 available, 3 aggregated h3 unavailable", {
  expect_equal(
    add_pm(input_data_h3() %>% dplyr::mutate(h3 = c('882a930a23fffff', '834894fffffffff', '8328c3fffffffff')), type = 'h3'),
    tibble::tibble(
      id = c( "55000100280","55000100280","55000100280",
              "55000100281","55000100281", "55000100281","55000100281",
              "55000100282", "55000100282","55000100282"),
      h3 = c(rep("882a930a23fffff", 3), rep('834894fffffffff', 4), rep('8328c3fffffffff', 3)),
      start_date = as.Date(c("2008-09-09","2008-09-09","2008-09-09",
                             "2007-08-05","2007-08-05","2007-08-05","2007-08-05",
                             "2015-08-31","2015-08-31", "2015-08-31")),
      end_date = as.Date(c("2008-09-11","2008-09-11", "2008-09-11",
      ...
      date = as.Date(c("2008-09-09", "2008-09-10","2008-09-11",
                       ...
                       "2015-08-31","2015-09-01","2015-09-02")),
      year = c(2008,2008,2008,2007,2007,2007,2007,2015,2015,2015),
      h3_3 = c(rep("832a93fffffffff", 3), rep('834894fffffffff-834890fffffffff', 4),
               rep('8328c3fffffffff-8328dcfffffffff-8328defffffffff-8328d3fffffffff', 3)),
      pm_pred = c(8.227,9.576,13.05,
                  rep(NA, 7)),
      pm_se = c(1.133,2.074,2.9,
                rep(NA, 7))
